            ...
            <div className="main_wrap">
                ...
                <div className="col-left">
                    ...
                    <div className="sub_path">
                        ...
                        <ul className="menu-list">
                            ...
                            <li>
                                <Link id="transactionHistory" to="/AccTransactionHistory" className="select">Transaction&nbsp;History
                                </Link>
                            </li>
                            <li>
                ...
                <div className="col-center report">
                    ...
                    <table id="table_log" className="table01">
                        <tbody>
                            <tr>
                                <th class="align-L">Date/Time</th>
                                <th class="align-R">Deposit From Upline</th>
                                <th class="align-R">Deposit to Downline</th>
                                <th class="align-R">WihtDraw By Upline</th>
                                <th class="align-R">WithDraw From Downline</th>
                                <th>Balance</th>
                                <th>Remark</th>
                                <th>From/To</th>
                            </tr>
...
export default AccTransactionHistory;